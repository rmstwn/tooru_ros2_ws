...
class GetVelocity_Response(metaclass=Metaclass_GetVelocity_Response):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.velocity = array.array('i', kwargs.get('velocity', []))
    ...
    def velocity(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'velocity' array.array() must have the type code of 'i'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'velocity' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._velocity = array.array('i', value)
