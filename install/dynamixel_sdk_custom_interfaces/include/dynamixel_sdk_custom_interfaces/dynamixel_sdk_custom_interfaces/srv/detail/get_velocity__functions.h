...
#ifndef DYNAMIXEL_SDK_CUSTOM_INTERFACES__SRV__DETAIL__GET_VELOCITY__FUNCTIONS_H_
#define DYNAMIXEL_SDK_CUSTOM_INTERFACES__SRV__DETAIL__GET_VELOCITY__FUNCTIONS_H_
 ...
 * calls
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Request__init().
...
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Request__fini()
 ...
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamixel_sdk_custom_interfaces
...
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamixel_sdk_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamixel_sdk_custom_interfaces
...
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__GetVelocity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DYNAMIXEL_SDK_CUSTOM_INTERFACES__SRV__DETAIL__GET_VELOCITY__FUNCTIONS_H_
